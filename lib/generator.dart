...
abstract final class TokenGenerator {
  static Future<TokenExchangeResponse> generate({required bool longLived}) async {
    try {
      ...
      final server = await _startRedirectionServer(authCodeCompleter, port: redirectionPort, endpoint: '/callback');
...
Future<HttpServer> _startRedirectionServer(
